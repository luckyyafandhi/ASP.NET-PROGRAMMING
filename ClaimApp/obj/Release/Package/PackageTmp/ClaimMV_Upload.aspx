...
<asp:Content ID="Content2" ContentPlaceHolderID="bodyPlaceHolder" runat="server">
    ...
    <section class="content">
        <div class="box box-info">
            ...
            <asp:SqlDataSource ID="dsLastClaim" runat="server" ConnectionString="<%$ ConnectionStrings:ClaimAppConnectionStringLive %>" SelectCommand="select MAX(TransactionNumber) AS TransactionNumber,PolicyNo,ChasisNumber,EngineNumber from ClaimMotorVehicle 
WHERE Type_Input = 'Upload Input' AND CreateBy = @session GROUP BY PolicyNo,ChasisNumber,EngineNumber">
            ...
            <asp:SqlDataSource ID="ClaimTemp" runat="server" ConnectionString="<%$ ConnectionStrings:ClaimAppConnectionStringLive %>" SelectCommand="select * from ClaimMotorVehicle_Temp 
...
Where TransactionNumber = (SELECT MAX(TransactionNumber) AS TransactionNumber from ClaimMotorVehicle WHERE Type_Input = 'Upload Input' AND CreateBy = @SA)">
            ...
            <asp:SqlDataSource ID="dsClaimUpload" runat="server" ConnectionString="<%$ ConnectionStrings:ClaimAppConnectionStringLive %>" SelectCommand="select * from ClaimMotorVehicle Where TransactionNumber = (SELECT MAX(TransactionNumber) AS TransactionNumber from ClaimMotorVehicle WHERE Type_Input = 'Upload Input' AND CreateBy = @SA)">
                <SelectParameters>
                    <asp:SessionParameter Name="SA" SessionField="userName" />
                </SelectParameters>
            </asp:SqlDataSource>
