...
<asp:Content ID="Content2" ContentPlaceHolderID="bodyPlaceHolder" runat="server">
    ...
    <section class="content">
        ...
        <asp:SqlDataSource ID="dsClaimManual" runat="server" ConnectionString="<%$ ConnectionStrings:ReksaAppConnectionString2 %>" SelectCommand="SELECT * FROM [ClaimMotorVehicle]"></asp:SqlDataSource>
    </section>
</asp:Content>
